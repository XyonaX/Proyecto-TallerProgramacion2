...
namespace Proyecto_Taller_2
{
    public class UcClientes : UserControl
    {
        ...
        private void BuildUI()
        {
            ...
            var flFoot = new FlowLayoutPanel { 
                FlowDirection = FlowDirection.LeftToRight,
                WrapContents = false,
                AutoSize = true
            };

            lblFooter = new Label { AutoSize = true, Text = "Mostrando 1–5 de 5", ForeColor = ColText, Font = new Font("Segoe UI", 9f), Margin = new Padding(94, 0, 8, 0) };
            btnPrev = MakeGhost("Anterior"); 
            btnPrev.Enabled = false;
            btnPrev.Margin = new Padding(0, 0, 8, 0);
            btnNext = MakeGhost("Siguiente"); 
            ...
            flFoot.Location = new Point(
                (footer.ClientSize.Width - flFoot.PreferredSize.Width) / 2,
                (footer.ClientSize.Height - flFoot.PreferredSize.Height) / 2
            );
